...
app.post("/submit", (req, res) => {
  ...
  var ran_1 = Math.floor(Math.random()*adj.length);
  var ran_2 = Math.floor(Math.random()*noun.length);


  var band_name= adj[ran_1] +" "+ noun[ran_2];

  res.render("index.ejs",{band_name_send:band_name})
